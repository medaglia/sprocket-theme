	...
	<div class="wrap">
		...
		<form method="post" action="options.php">
			...
			<table class="form-table">
				...
				<tr valign="top"><th scope="row"><?php _e('Twitter User', 'roots'); ?></th>
					<td>
						<fieldset><legend class="screen-reader-text"><span><?php _e('Twitter Username', 'roots'); ?></span></legend>
							<input type="text" name="roots_theme_options[twitter_user]" id="twitter_user" value="<?php echo esc_attr($roots_options['twitter_user']); ?>" /><br/>
							<small class="description"><?php printf(__('Will display a follow button.', 'roots')); ?></small>							
						</fieldset>
					</td>
				</tr>
				
				<tr valign="top"><th scope="row"><?php _e('Facebook User', 'roots'); ?></th>
					<td>
						<fieldset><legend class="screen-reader-text"><span><?php _e('Facebook Username', 'roots'); ?></span></legend>
							<input type="text" name="roots_theme_options[facebook_user]" id="facebook_user" value="<?php echo esc_attr($roots_options['facebook_user']); ?>" /><br/>
							<small class="description"><?php printf(__('Will display a follow button.', 'roots')); ?></small>							
						</fieldset>
					</td>
				</tr>
...
function roots_theme_options_validate($input) {
	...
	if (isset($input['twitter_user']))
		$output['twitter_user'] = $input['twitter_user'];	

	if (isset($input['facebook_user']))

...
global $wp_scripts;
wp_enqueue_script('theme-script', get_template_directory_uri() . '/js/scripts.js', array('jquery'), false, true);
wp_enqueue_script('theme-script', get_template_directory_uri() . '/js/libs/modernizr-2.0.6.min.js', false, false, false);
...
function roots_setup() {
	...
	set_post_thumbnail_size( 190, 120, false );
